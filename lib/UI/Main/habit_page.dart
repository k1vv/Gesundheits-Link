...
class _HabitsState extends State<Habits> {
  ...
  Future<void> _updateIsStarredInDatabase(
  
  String habitId, bool isStarred) async {
  ...
  void _fetchHabits() async {
    ...
    if (user != null) {
      ...
      try {
        DatabaseEvent event =
            await _databaseReference.child(databasePath).once();
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        elevation: 4,
                        backgroundColor:
                            const Color.fromARGB(255, 255, 130, 149),
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: () async {
                                            setState(() {
                                              habits[index].isStarred =
                                                  !habits[index].isStarred;
                                            });
                                            await _updateIsStarredInDatabase(
                                                habits[index].id,
                                                habits[index].isStarred);
                                          },
                                          child: Stack(
